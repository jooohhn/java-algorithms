 ...
 *
 * Solution - 1) If characters are equal length, iterate through both strings making sure only one
 * character is changed 2) If characters are different lengths, iterate through both strings making
 * sure only one character is added
 */
public class Q1_5 {
