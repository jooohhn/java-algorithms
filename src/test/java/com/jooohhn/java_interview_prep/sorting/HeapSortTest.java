...
public class HeapSortTest {
  ...
  public void generalCases() throws Exception {
    ...
    assertArrayEquals(arr1Sorted, HeapSort.heapSort(arr1));
    ...
    assertArrayEquals(arr2Sorted, HeapSort.heapSort(arr2));
  }
  ...
  public void edgeCases() throws Exception {
    ...
    assertArrayEquals(sortedIntArr, HeapSort.heapSort(intArr));
