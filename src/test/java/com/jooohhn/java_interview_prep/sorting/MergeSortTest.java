...
public class MergeSortTest {
  ...
  public void generalCases() throws Exception {
    ...
    assertArrayEquals(arr1Sorted, MergeSort.mergeSortRecursive(arr1));
    ...
    assertArrayEquals(arr2Sorted, MergeSort.mergeSortRecursive(arr2));
  }
  ...
  public void edgeCases() throws Exception {
    ...
    assertArrayEquals(sortedIntArr, MergeSort.mergeSortRecursive(intArr));
