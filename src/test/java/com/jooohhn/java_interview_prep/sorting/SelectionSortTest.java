...
public class SelectionSortTest {
  ...
  public void generalCases() throws Exception {
    ...
    assertArrayEquals(arr1Sorted, SelectionSort.selectionSort(arr1));
    ...
    assertArrayEquals(arr2Sorted, SelectionSort.selectionSort(arr2));
  }
  ...
  public void edgeCases() throws Exception {
    ...
    assertArrayEquals(sortedIntArr, SelectionSort.selectionSort(intArr));
